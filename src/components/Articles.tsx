...
const articles = [
  ...
  // Wave 3 — international English (US/UK)
  { source: 'The Daily Beast', title: 'Humanoid Robot Spotted Chasing Wild Animals Through Warsaw, Poland', url: 'https://www.thedailybeast.com/humanoid-robot-spotted-chasing-wild-animals-through-warsaw-poland/', domain: 'thedailybeast.com' },
  { source: 'CBS News', title: 'Humanoid robot Edward Warchocki chased a herd of wild boars in Warsaw', url: 'https://x.com/CBSNews/status/2044532056605266265', domain: 'cbsnews.com' },
  { source: 'Channel 4 News', title: 'Humanoid robot named Edward Warchocki chased off wild boars in Warsaw', url: 'https://www.facebook.com/Channel4News/videos/1161338062729413/', domain: 'channel4.com' },
  { source: 'AOL', title: "Humanoid robot chases pack of wild boars: 'The hero we don't deserve'", url: 'https://www.aol.com/news/humanoid-robot-chases-pack-wild-132317628.html', domain: 'aol.com' },
  { source: 'AOL UK', title: 'Humanoid robot chases wild boars across Poland parking lot', url: 'https://www.aol.co.uk/articles/humanoid-robot-chases-wild-boars-205443030.html', domain: 'aol.co.uk' },
  { source: 'MSN', title: 'Humanoid robot Edward chases boars in viral video', url: 'https://www.msn.com/en-us/news/world/humanoid-robot-edward-chases-boars-in-viral-video/ar-AA20VgNm', domain: 'msn.com' },
  { source: 'Yahoo News UK', title: 'Humanoid robot chases wild boars in the Polish capital Warsaw', url: 'https://uk.news.yahoo.com/humanoid-robot-chases-wild-boars-092221863.html', domain: 'uk.news.yahoo.com' },
  { source: 'Dexerto', title: 'Humanoid robot Edward goes viral chasing off wild boars in Poland', url: 'https://www.dexerto.com/entertainment/humanoid-robot-named-edward-goes-viral-chasing-off-wild-boars-in-poland-3353124/', domain: 'dexerto.com' },
  { source: 'The Blaze', title: 'Why is a Chinese robot chasing wild boars in Poland?', url: 'https://www.theblaze.com/return/chinese-robot-streets-of-poland', domain: 'theblaze.com' },
  { source: 'NewsBreak', title: 'A Humanoid Robot Tried to Herd Wild Boars — and Failed Spectacularly', url: 'https://www.newsbreak.com/gadget-review-324582152/4591777451853-a-humanoid-robot-tried-to-herd-wild-boars-and-failed-spectacularly', domain: 'newsbreak.com' },
  { source: 'iTWire', title: '2026 is the year robots got real — running, fighting, herding pigs', url: 'https://itwire.com/your-it-news/mobility/the-machines-are-running,-fighting,-and-herding-pigs-2026-is-the-year-robots-got-real.html', domain: 'itwire.com' },
  { source: 'DNYUZ', title: 'Video Shows Humanoid Robot Chasing a Pack of Wild Boars', url: 'https://dnyuz.com/2026/04/13/video-shows-humanoid-robot-chasing-a-pack-of-wild-boars/', domain: 'dnyuz.com' },
  { source: 'Shoreline Media', title: 'Viral video shows a humanoid robot chasing wild boars in Poland', url: 'https://www.shorelinemedia.net/ludington_daily_news/videos/viral-video-shows-a-humanoid-robot-chasing-wild-boars-in-poland/video_9361dcbf-3316-5210-8e8e-d2d50efe8b2d.html', domain: 'shorelinemedia.net' },
  { source: 'RobotsBeat', title: "Poland's First Humanoid Influencer Draws Brands and Millions Of Views", url: 'https://robotsbeat.com/humanoid-robot-influencer-poland/', domain: 'robotsbeat.com' },
  { source: "Let's Data Science", title: 'Humanoid Robot Chases Boars in Poland Demonstration', url: 'https://letsdatascience.com/news/humanoid-robot-chases-boars-in-poland-demonstration-7e3820c6', domain: 'letsdatascience.com' },
  { source: 'CNN en Español', title: 'Un robot llamado Edward Warchocki persigue jabalíes salvajes en Polonia', url: 'https://cnnespanol.cnn.com/2026/04/15/mundo/video/robot-perseguir-jabalies-polonia-trax', domain: 'cnnespanol.cnn.com' },
  // Wave 3 — Polish (new outlets)
  { source: 'TVP Info', title: 'Sejm. W konferencji Konfederacji wziął udział robot — Edward Warchocki', url: 'https://www.tvp.info/92274293/sejm-w-konferencji-konfederacji-o-nowoczesnych-technologiach-udzial-wzial-robot-humanoidalny-edward-warchocki', domain: 'tvp.info' },
  { source: 'Polsat News', title: 'Edward Warchocki w akcji. Nagranie z Polski obiegło świat', url: 'https://www.polsatnews.pl/wiadomosc/2026-04-15/edward-warchocki-w-akcji-nagranie-z-polski-obieglo-swiat/', domain: 'polsatnews.pl' },
  { source: 'Chip.pl', title: 'Dziki kontra robot na warszawskim parkingu. Nagranie podbija internet', url: 'https://www.chip.pl/2026/04/w-chinach-roboty-tancza-a-w-polsce-gonia-dziki-edward-warchocki-znow-w-akcji', domain: 'chip.pl' },
  { source: 'Telepolis', title: 'Edward Warchocki to ściemniacz. Nie dajcie się nabrać', url: 'https://www.telepolis.pl/artykuly/edward-warchocki-robot-polska-zabawa', domain: 'telepolis.pl' },
  { source: 'Press.pl', title: 'Edward Miszczak: Taniec z gwiazdami wciąż jest hitem', url: 'https://www.press.pl/tresc/92052,edward-miszczak_-mysle-o-nowych-produkcjach_-ale-_taniec-z-gwiazdami_-wciaz-jest-hitem', domain: 'press.pl' },
  { source: 'Jastrząb Post', title: 'Edward Miszczak obśmiany w kabaretach Polsatu za taniec z robotem', url: 'https://telewizja.jastrzabpost.pl/edward-miszczak-obsmiany-w-kabaretach-polsatu-za-taniec-z-robotem-edwardem-warchockim,7275926513711392a', domain: 'jastrzabpost.pl' },
  { source: 'Jastrząb Post', title: 'Edward Miszczak pląsa na ściance TzG z robotem', url: 'https://telewizja.jastrzabpost.pl/edward-miszczak-plasa-na-sciance-tzg-z-robotem-ale-wywijali,7274591446145216a', domain: 'jastrzabpost.pl' },
  { source: 'Świat Gwiazd', title: 'Kabaret bezwstydnie wyśmiał Edwarda Miszczaka', url: 'https://swiatgwiazd.pl/kabaret-bezwstydnie-wysmial-edwarda-miszczaka-nie-przepuscili-takiego-zartu-ms-wmk-160426', domain: 'swiatgwiazd.pl' },
  { source: 'Super Express', title: 'Edward przegonił dziki w Warszawie. Niezwykłe nagranie', url: 'https://www.se.pl/warszawa/edward-warchocki-przegonil-dziki-w-warszawie-niezwykle-nagranie-z-udzialem-polskiego-robota-aa-tn3p-kaHu-wcho.html', domain: 'se.pl' },
  { source: 'Echo Dnia', title: 'Niezwykły pojedynek w Sandomierzu: Gabryś Kuliberda kontra robot', url: 'https://echodnia.eu/swietokrzyskie/niezwykly-pojedynek-w-sandomierzu-na-flagi-miedzy-gabrysiem-kuliberda-a-robotem-edwardem-warchockim-tlumy-ludzi-zobaczcie-zdjecia/ar/c13p2-28942211', domain: 'echodnia.eu' },
  { source: 'Co Za Dzień Sandomierz', title: 'Mały geniusz kontra robot — wielkie emocje', url: 'https://sandomierz.cozadzien.pl/sandomierz/maly-geniusz-kontra-robot-i-wielkie-emocje/81504', domain: 'cozadzien.pl' },
  { source: 'Tyna.info.pl', title: 'Mały geniusz kontra robot humanoidalny — pojedynek w Sandomierzu', url: 'https://tyna.info.pl/pl/738_sandomierz/233565_maly-geniusz-kontra-robot-humanoidalny-niezwykly-pojedynek-w-sandomierzu.html', domain: 'tyna.info.pl' },
  { source: 'Evertiq', title: 'Robot AI Edward Warchocki na Evertiq Expo Kraków!', url: 'https://evertiq.pl/design/2026-04-22-robot-ai-edward-warchocki-pojawi-sie-na-evertiq-expo-krakow', domain: 'evertiq.pl' },
  { source: 'Politechnika Warszawska', title: 'Edward Warchocki na Politechnice Warszawskiej', url: 'https://www.pw.edu.pl/aktualnosci/edward-warchocki-na-politechnice-warszawskiej', domain: 'pw.edu.pl' },
  { source: 'wPolsce24.tv', title: 'Polski robot-influencer robi globalną karierę', url: 'https://wpolsce24.tv/rozrywka/polski-robotinfluencer-robi-globalna-kariere,74289', domain: 'wpolsce24.tv' },
  { source: 'o2.pl', title: 'Nagranie z Warszawy obiegło świat. Robot gonił dziki', url: 'https://www.o2.pl/informacje/nagranie-z-warszawy-obieglo-swiat-robot-gonil-dziki-po-centrum-7275846138671681v', domain: 'o2.pl' },
  { source: 'Nasze Miasto', title: 'Edward przegonił dziki. Czy miasto powinno zainwestować w roboty?', url: 'https://warszawa.naszemiasto.pl/edward-warchocki-skutecznie-przegonil-dziki-czy-miasto-powinno-zainwestowac-w-podobne-roboty/ar/c1p2-28904519', domain: 'naszemiasto.pl' },
  { source: 'Warszawa Za Darmo', title: 'Robot influencer na ulicach Warszawy — przyciąga tłumy', url: 'https://warszawazadarmo.pl/przewodnik-po-warszawie/robot-influencer-na-ulicach-warszawy/', domain: 'warszawazadarmo.pl' },
  { source: 'Radio Zachód', title: 'Robot Edward Warchocki sprawdzony pod kątem zagrożeń', url: 'https://zachod.pl/1449613/robot-edward-warchocki-zostal-sprawdzony-pod-katem-zagrozen-straznicy-wiedza-jak-go-awaryjnie-wylaczyc/', domain: 'zachod.pl' },
  { source: 'MamStartup', title: 'Czy Edek dogoni Błyskawicę? Robot na pekińskim półmaratonie', url: 'https://mamstartup.pl/czy-edek-warchocki-dogoni-blyskawice-humanoidalny-robot-miazdzy-biegaczy-na-pekinskim-polmaratonie/', domain: 'mamstartup.pl' },
  { source: 'Android.com.pl', title: 'Kiedyś Kwejk, dziś humanoidy. To oni stoją za sukcesem Edwarda', url: 'https://android.com.pl/tech/1034876-sukces-robota-edwarda-warchockiego/', domain: 'android.com.pl' },
  // Wave 3 — Latin America / international Spanish
  { source: 'La Nación (AR)', title: 'Terminator 1: Polonia encontró insólita solución a tema que preocupa en Argentina', url: 'https://www.lanacion.com.ar/economia/campo/terminator-1-en-polonia-le-encontraron-una-insolita-solucion-a-un-tema-que-preocupa-en-la-argentina-nid14042026/', domain: 'lanacion.com.ar' },
  { source: 'El Salvador', title: 'El influencer mecánico que persigue animales salvajes', url: 'https://www.elsalvador.com/noticias/internacional/robot-edward-warchocki-unitree-g1/1270013/2026/', domain: 'elsalvador.com' },
  { source: 'SwissInfo', title: 'El robot humanoide que asombra a Polonia con sus interacciones', url: 'https://www.swissinfo.ch/spa/%22edward-warchocki%22,-el-robot-humanoide-que-asombra-a-polonia-con-sus-interacciones/91266959', domain: 'swissinfo.ch' },
