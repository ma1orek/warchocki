...
const eventsPl = [
  ...
  'Wizyta u prezydent Gdańska Aleksandry Dulkiewicz',
  'Spotkanie z wicepremierem Władysławem Kosiniakiem-Kamyszem',
  'Dzień Dziecka z premierem Donaldem Tuskiem w KPRM',
]
...
const eventsEn = [
  ...
  'Visit to Gdańsk Mayor Aleksandra Dulkiewicz',
  'Meeting Deputy PM Władysław Kosiniak-Kamysz',
  "Children's Day with PM Donald Tusk at the Chancellery",
]
