...
export const translations = {
  pl: {
    ...
    productsIntro: 'Trafiam do każdego - teraz dosłownie. Dwa smaki, zero dodatku cukru, witaminy w każdej butelce. Dostępne w całej Polsce w sieci sklepów DINO. No i elegancko.',
    ...
    prodAvailDesc: 'Szukaj napojów Edwarda Warchockiego na półkach sieci DINO w całej Polsce.',
    ...
    prodCtaTitle: 'Złap Edwarda Warchockiego w DINO',
  ...
  en: {
    ...
    productsIntro: 'I reach everyone - now literally. Two flavors, zero added sugar, vitamins in every bottle. Available across Poland at DINO stores. Elegant.',
    ...
    prodAvailDesc: "Look for Edward Warchocki's drinks on the shelves of DINO stores all over Poland.",
